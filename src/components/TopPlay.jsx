...
const TopChartCard = ({ song, index, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`w-full flex flex-row items-center hover:bg-[#454857] ${activeSong?.title === song?.title ? 'bg-[#454857]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
